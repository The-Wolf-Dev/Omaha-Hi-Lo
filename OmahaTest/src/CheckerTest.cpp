...
TEST_F(CheckerTest, ValidStraightWithValidCards) {
...
TEST_F(CheckerTest, ValidStraightWithLowAce) {
	std::vector<Card> cards{ Card(Rank::_2, Suit::Spaders), Card(Rank::_3, Suit::Spaders), Card(Rank::_4, Suit::Spaders), Card(Rank::_5, Suit::Spaders), Card(Rank::A, Suit::Spaders) };
	checker.validate(cards);
	EXPECT_THAT(checker.isStraight(), IsTrue());
}
...
TEST_F(CheckerTest, InvalidFlushWithInvalidCards) {
...
TEST_F(CheckerTest, InvalidStraightFlushWithInvalidCards) {
...
TEST_F(CheckerTest, CompareHighHand) {
	std::vector<Card> flush{ Card(Rank::_5, Suit::Spaders), Card(Rank::K, Suit::Spaders), Card(Rank::_2, Suit::Spaders), Card(Rank::J, Suit::Spaders), Card(Rank::T, Suit::Spaders) };
	std::vector<Card> straightFlush{ Card(Rank::A, Suit::Spaders), Card(Rank::K, Suit::Spaders), Card(Rank::Q, Suit::Spaders), Card(Rank::J, Suit::Spaders), Card(Rank::T, Suit::Spaders) };

	checker.validate(flush);
	checker.validate(straightFlush);
	EXPECT_THAT(checker.getHighHand().getRank(), Eq(HighHandRank::StraightFlush));
}
